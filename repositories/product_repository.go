...
func (repo *ProductRepository) GetAll() ([]models.Products, error) {
	query := "SELECT id, name, price, stock FROM kasir.products"
...
func (repo *ProductRepository) Create(product *models.Products) error {
	query := "INSERT INTO kasir.products (name, price, stock) VALUES ($1, $2, $3) RETURNING id"
...
func (repo *ProductRepository) GetByID(id int) (*models.Products, error) {
	query := "SELECT id, name, price, stock FROM kasir.products WHERE id = $1"
...
func (repo *ProductRepository) Update(product *models.Products) error {
	query := "UPDATE kasir.products SET name = $1, price = $2, stock = $3 WHERE id = $4"
...
func (repo *ProductRepository) Delete(id int) error {
	query := "DELETE FROM kasir.products WHERE id = $1"
